...
import bigdata.hermesfuxi.flink.connectors.kafka.KafkaToKafkaExactlyOnceDemo;
...
/**
 *  从 kafka 到 mysql 实现端到端Exactly Once语义（二次提交实现）
 */
public class KafkaToMySQLExactlyOnceDemo {
    public static void main(String[] args) throws Exception {
        ...
        result.addSink(new MySQLTwoPhaseCommitSink());
