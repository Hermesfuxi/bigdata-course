package bigdata.hermesfuxi.hdfs.client;

import bigdata.hermesfuxi.hdfs.utils.HDFSUtils;
...
//            Path symlink = fileStatus.getSymlink();
    ...
    public static void read() throws Exception {
        FileSystem fileSystem = HDFSUtils.getHDFSFileSystem();
        FSDataInputStream fsDataInputStream = fileSystem.open(new Path("/test2.txt"));
