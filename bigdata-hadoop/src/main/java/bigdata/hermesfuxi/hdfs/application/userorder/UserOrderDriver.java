package bigdata.hermesfuxi.hdfs.application.userorder;


import bigdata.hermesfuxi.hdfs.application.userorder.domain.UserOrderBean;
import bigdata.hermesfuxi.hdfs.utils.LoggerUtils;
